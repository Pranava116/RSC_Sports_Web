  ...
  return (
    <>
      ...
      >
        ...
        {screen > 650 ? (
          <p className="mb-4 font-normal text-md text-wrap text-gray-500 dark:text-gray-400">
            {props.desc}
          </p>
        ) : (
          <p className="mb-4 font-normal text-wrap text-gray-500 dark:text-gray-400">
            {props.desc_sm}
          </p>
        )}
        ...
        <div className="flex flex-row justify-center items-center">
          <Link
            to={props.link}
            className="mt-3 text-white origin-right hover:text-transparent text-2xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 scale-x-100transition-transform duration-300"
          >
            Know More
          </Link>
          <svg
